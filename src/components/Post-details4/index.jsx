                    ...
                    <div className="col-lg-10">
                      <div className="cont">
                        <div className="spacial">
                          <p>
                          Our planned development offers a unique layout featuring multiple 5 and 6 cents individual plots, strategically designed along a dual axis to seamlessly integrate with the urban fabric. Each plot is demarcated with planned vegetation, providing residents with a sense of privacy and tranquility. 
                          </p>
                        </div>
                      
                        <p >
                        With two typologies of plots residential and retreat, our development caters to a diverse range of customers. Ideal for those seeking affordable housing with urban amenities in the outskirts, as well as individuals desiring a rural retreat closer to nature.
                        </p>
                        <p >
                        Additionally, our commercial layout includes essential amenities such as a supermarket and pharmacy, complemented by a clubhouse offering various amenities for community residents.
                        </p>
          ...
          <div className="tex-bg">Work</div>
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="mb-10">
                              <img src="/assets/img/Architectures/projects/Vermont Valley 2.jpg" alt="" />
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="mb-10">
                              <img src="/assets/img/Architectures/projects/Vermont Valley 1.jpg" alt="" />
                            </div>
                          </div>
                        </div>
                        {/* <p>
